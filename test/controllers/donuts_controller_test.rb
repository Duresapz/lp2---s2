...
class DonutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donut" do
    assert_difference('Donut.count') do
      post donuts_url, params: { donut: { image: @donut.image, name: @donut.name, nutriscore: @donut.nutriscore, price: @donut.price } }
    end
  ...
  test "should update donut" do
    patch donut_url(@donut), params: { donut: { image: @donut.image, name: @donut.name, nutriscore: @donut.nutriscore, price: @donut.price } }
